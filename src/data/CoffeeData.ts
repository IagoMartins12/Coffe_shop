const CoffeeData = [
  ...
  },
  {
    id: 'C7',
    name: 'Cappucchino',
    description: `Cappuccinos are a classic Italian type of coffee drink made of espresso, steamed Leite, and thick foam in equal parts. The name comes from the resemblance to the hoods worn by Capuchin monks. Making cappuccino is relatively easy and can be done at home too if you know how to make espresso.`,
    roasted: 'Medium Roasted',
  ...
  },
  {
    id: 'C13',
    name: 'Latte',
    description: `A latte is an espresso Com Leite Vaporizado and a dollop of Leite foam on top. This beverage is more prevalent in America than other coffee drinks like cappuccinos because it contains less foam, making it smoother and gentler for those with sensitive palettes. And if you want to spice up your latte, add some flavouring syrup. To make an iced version of this drink, simply pour espresso and steamed Leite over ice cubes.`,
    roasted: 'Medium Roasted',
  ...
  },
  {
    id: 'C16',
    name: 'Macchiato',
    description: `The word "macchiato" means spotted, so a macchiato espresso is an espresso with a splash of Leite. Most coffee shops will top off this type of coffee drink with some foamed Leite instead of just steamed Leite for what's known as a traditional macchiato. `,
    roasted: 'Medium Roasted',
