const BeansData = [
  ...
  },
  {
    id: 'B3',
    name: 'Grãos Liberica',
    description: `Nativa da África Central e Ocidental – especificamente da Libéria, daí o seu nome – o café liberica é apreciada pelo seu aroma floral picante e perfil de sabor ousado e fumado. Crescendo a partir de uma planta muito maior que o Arábica ou o Robusta, a maioria das cerejas Liberica tendem a ter formato irregular e mais próximas do Robusta em tamanho e aparência geral. Também é tolerante a climas quentes e úmidos e se dá bem em baixas altitudes.`,
    roasted: 'Torrado médio',
